...
const Step5Confirmation = () => {
  ...
  return (
    <div className="bg-surface font-body-md text-on-surface antialiased min-h-screen">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-surface/90 backdrop-blur-md shadow-[0_1px_8px_rgba(0,0,0,0.04)]"><div className="h-20 max-w-[1440px] mx-auto px-margin flex items-center justify-between"><div className="flex items-center gap-space-md"><img alt="TEDxCRCE Logo" className="h-8 w-auto object-contain" src="https://lh3.googleusercontent.com/aida/AEtjO1Wv17fPGZaLmQXq7a6amA4WbWcLH5hhV1oOotGWaoJyu7BBK5QpPXRJVVHyUfqU6hlIRA0KgAXweESkb3tTpGbayr8SEhKEjGHVX16vdNMfTTCwMS3JQHPJJzYqXqBYYPiH4h88wEZWanWCB3hY9QFIypC9rtQbra8GBwzAaR5WoJTupcm3yuMxbo_ucCmW4oBpaYB2Kkbg35Mx8NCnVsTkKkSWKH66aoTVzSwA5hSN8ZCvCX-noY28eCs"/><div className="flex flex-col"><span className="font-headline-sm text-headline-sm uppercase tracking-tight text-on-surface">TEDxCRCE</span><span className="font-label-badge text-label-badge uppercase tracking-widest text-primary">Internship Expo 2026</span></div></div><nav className="hidden md:flex items-center gap-space-lg" data-active-classes="text-primary font-bold"><a aria-current="page" className="transition-colors text-primary font-bold" data-path="home" href="#">Home</a><a className="font-label-lg text-label-lg text-on-surface-variant hover:text-on-surface transition-colors" data-path="about" href="#">About</a><a className="font-label-lg text-label-lg text-on-surface-variant hover:text-on-surface transition-colors" data-path="companies" href="#">Companies</a><a className="font-label-lg text-label-lg text-on-surface-variant hover:text-on-surface transition-colors" data-path="sponsors" href="#">Sponsors</a><a className="font-label-lg text-label-lg text-on-surface-variant hover:text-on-surface transition-colors" data-path="contact" href="#">Contact</a></nav><div className="flex items-center gap-space-md"><a className="inline-flex items-center justify-center px-space-lg py-space-sm bg-primary-container text-on-primary font-label-lg text-label-lg rounded-xl shadow-[2px_2px_0px_rgba(48,48,48,0.2)] hover:bg-primary transition-all duration-150" data-path="registration" href="#">Register</a><div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center"><span className="material-symbols-outlined text-on-primary text-[18px]">person</span></div></div></div></header><main className="w-full pt-20 bg-surface min-h-screen"><div className="flex flex-col w-full items-center justify-start relative overflow-hidden py-space-xl">
...
<div className="w-full max-w-[580px] px-space-md mb-space-md flex items-center justify-between">
<div className="inline-flex items-center gap-space-xs bg-tertiary-fixed text-on-tertiary-fixed px-space-sm py-1 rounded-sm shadow-sm rotate-[-1deg]">
...
<div className="w-full max-w-[580px] px-space-md flex flex-col items-center">
<div className="w-full bg-surface-container-lowest rounded-xl shadow-[6px_6px_0px_rgba(48,48,48,0.12)] p-space-xl relative flex flex-col items-center">
...
<div className="flex flex-col">
<span className="font-label-badge text-label-badge text-surface-variant tracking-wider uppercase">Reference Token</span>
...
<a className="text-primary font-semibold hover:underline flex items-center gap-0.5" data-path="contact" href="#">
        Contact Helpdesk
...
</div></main><footer className="w-full bg-inverse-surface text-inverse-on-surface py-space-xl"><div className="max-w-[1440px] mx-auto px-margin flex flex-col gap-space-xl"><div className="grid grid-cols-1 md:grid-cols-1 xl:grid-cols-12 gap-8 items-start"><div className="md:col-span-5 flex flex-col gap-space-md"><div className="flex items-center gap-space-sm"><img alt="TEDxCRCE Logo" className="h-8 w-auto object-contain brightness-0 invert" src="https://lh3.googleusercontent.com/aida/AEtjO1Wv17fPGZaLmQXq7a6amA4WbWcLH5hhV1oOotGWaoJyu7BBK5QpPXRJVVHyUfqU6hlIRA0KgAXweESkb3tTpGbayr8SEhKEjGHVX16vdNMfTTCwMS3JQHPJJzYqXqBYYPiH4h88wEZWanWCB3hY9QFIypC9rtQbra8GBwzAaR5WoJTupcm3yuMxbo_ucCmW4oBpaYB2Kkbg35Mx8NCnVsTkKkSWKH66aoTVzSwA5hSN8ZCvCX-noY28eCs"/><span className="font-headline-sm text-headline-sm uppercase tracking-tight text-surface-bright">TEDxCRCE</span></div><p className="font-body-md text-body-md text-surface-variant max-w-sm">Internship Expo 2026. Empowering collegiate talent, intellectual curiosity, and high-growth opportunities under the spirit of ideas worth spreading.</p></div><div className="md:xl:col-span-4 flex flex-col gap-space-sm"><span className="font-label-badge text-label-badge uppercase tracking-widest text-primary-fixed">Quick Navigation</span><div className="flex flex-col gap-space-xs"><a className="font-body-md text-body-md text-surface-variant hover:text-surface-bright transition-colors" data-path="home" href="#">Home</a><a className="font-body-md text-body-md text-surface-variant hover:text-surface-bright transition-colors" data-path="about" href="#">About the Summit</a><a className="font-body-md text-body-md text-surface-variant hover:text-surface-bright transition-colors" data-path="companies" href="#">Participating Companies</a><a className="font-body-md text-body-md text-surface-variant hover:text-surface-bright transition-colors" data-path="sponsors" href="#">Our Sponsors</a><a className="font-body-md text-body-md text-surface-variant hover:text-surface-bright transition-colors" data-path="contact" href="#">Get In Touch</a></div></div><div className="md:xl:col-span-3 flex flex-col gap-space-sm"><span className="font-label-badge text-label-badge uppercase tracking-widest text-primary-fixed">Connect &amp; Follow</span><div className="flex flex-col gap-space-xs"><a className="font-body-md text-body-md text-surface-variant hover:text-surface-bright transition-colors" href="#">LinkedIn Official</a><a className="font-body-md text-body-md text-surface-variant hover:text-surface-bright transition-colors" href="#">Instagram Community</a><a className="font-body-md text-body-md text-surface-variant hover:text-surface-bright transition-colors" href="#">YouTube Channel</a><a className="font-body-md text-body-md text-surface-variant hover:text-surface-bright transition-colors" href="#">Student Portal</a></div></div></div><div className="pt-space-md border-t border-inverse-surface/40 flex flex-col md:flex-row justify-between items-center gap-space-sm font-body-sm text-body-sm text-surface-dim"><span>This independent TEDx event is operated under license from TED.</span><span>© 2026 TEDxCRCE Internship Expo. All rights reserved.</span></div></div></footer>
    </div>
  );
};
