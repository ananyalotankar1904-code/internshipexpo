...
const Step5Confirmation = () => {
  ...
  return (
    <div className="bg-surface font-body-md text-on-surface antialiased min-h-screen">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-surface/90 backdrop-blur-md shadow-[0_1px_8px_rgba(0,0,0,0.04)]"><div className="h-auto md:h-20 py-4 md:py-0 max-w-[1440px] mx-auto px-4 md:px-margin flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0"><div className="flex items-center gap-space-md"><div className="flex items-center"><img alt="TEDx Logo" className="h-10 md:h-14 w-auto object-contain" src={tedxLogo}/><span className="font-headline-sm text-2xl md:text-3xl uppercase tracking-tighter text-white font-bold ml-1 md:ml-1.5 leading-none">CRCE</span></div><div className="flex flex-col"><span className="font-label-badge text-label-badge uppercase tracking-widest text-primary">Internship Expo 2026</span></div></div><nav className="hidden md:flex items-center gap-space-lg" data-active-classes="text-primary font-bold"><a aria-current="page" className="transition-colors text-primary font-bold" data-path="home" href="#">Home</a><a className="font-label-lg text-label-lg text-on-surface-variant hover:text-on-surface transition-colors" data-path="about" href="#">About</a><a className="font-label-lg text-label-lg text-on-surface-variant hover:text-on-surface transition-colors" data-path="companies" href="#">Companies</a><a className="font-label-lg text-label-lg text-on-surface-variant hover:text-on-surface transition-colors" data-path="contact" href="#">Contact</a></nav><div className="flex items-center gap-space-md"><a className="inline-flex items-center justify-center px-space-lg py-space-sm bg-primary-container text-on-primary font-label-lg text-label-lg rounded-xl shadow-[2px_2px_0px_rgba(48,48,48,0.2)] hover:bg-primary transition-all duration-150" data-path="registration" href="#">Register</a><div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center"><span className="material-symbols-outlined text-on-primary text-[18px]">person</span></div></div></div></header><main className="w-full pt-32 md:pt-20 bg-surface min-h-screen"><div className="flex flex-col w-full items-center justify-start relative overflow-hidden py-space-xl">
...
</div></main><footer className="w-full bg-inverse-surface text-inverse-on-surface py-space-xl"><div className="max-w-[1440px] mx-auto px-margin flex flex-col gap-space-xl"><div className="grid grid-cols-1 md:grid-cols-1 xl:grid-cols-12 gap-8 items-start"><div className="md:col-span-5 flex flex-col gap-space-md"><div className="flex items-center gap-space-sm"><div className="flex items-center"><img alt="TEDx Logo" className="h-10 md:h-14 w-auto object-contain" src={tedxLogo}/><span className="font-headline-sm text-2xl md:text-3xl uppercase tracking-tighter text-white font-bold ml-1 md:ml-1.5 leading-none">CRCE</span></div></div><p className="font-body-md text-body-md text-white max-w-sm">Internship Expo 2026. Empowering collegiate talent, intellectual curiosity, and high-growth opportunities under the spirit of ideas worth spreading.</p></div><div className="md:xl:col-span-4 flex flex-col gap-space-sm"><span className="font-label-badge text-label-badge uppercase tracking-widest text-primary-fixed">Quick Navigation</span><div className="flex flex-col gap-space-xs"><a className="font-body-md text-body-md text-white hover:text-white transition-colors" data-path="home" href="#">Home</a><a className="font-body-md text-body-md text-white hover:text-white transition-colors" data-path="about" href="#">About the Summit</a><a className="font-body-md text-body-md text-white hover:text-white transition-colors" data-path="companies" href="#">Participating Companies</a><a className="font-body-md text-body-md text-white hover:text-white transition-colors" data-path="sponsors" href="#">Our Sponsors</a><a className="font-body-md text-body-md text-white hover:text-white transition-colors" data-path="contact" href="#">Get In Touch</a></div></div><div className="md:xl:col-span-3 flex flex-col gap-space-sm"><span className="font-label-badge text-label-badge uppercase tracking-widest text-primary-fixed">Connect &amp; Follow</span><div className="flex flex-col gap-space-xs"><a className="font-body-md text-body-md text-white hover:text-white transition-colors" href="#">LinkedIn Official</a><a className="font-body-md text-body-md text-white hover:text-white transition-colors" href="#">Instagram Community</a><a className="font-body-md text-body-md text-white hover:text-white transition-colors" href="#">YouTube Channel</a><a className="font-body-md text-body-md text-white hover:text-white transition-colors" href="#">Student Portal</a></div></div></div><div className="pt-space-md border-t border-inverse-surface/40 flex flex-col md:flex-row justify-between items-center gap-space-sm font-body-sm text-body-sm text-white"><span>This independent TEDx event is operated under license from TED.</span><span>© 2026 TEDxCRCE Internship Expo. All rights reserved.</span></div></div></footer>
    </div>
  );
};
