          ...
          <div className="w-full smoked-glass rounded-lg py-6 md:py-8 px-4 md:px-10 border border-border-hairline">
            <div className="flex flex-row justify-center items-center gap-12 md:gap-24">
              ...
              <div className="group flex flex-col items-center justify-center p-4 transition-all duration-300">
                <img src="/logos/medidivision.png" alt="Medivision" className="h-32 md:h-44 object-contain transition-all duration-300 scale-95 group-hover:scale-100" />
              </div>
              {/* Sponsor 2 */}
              <div className="group flex flex-col items-center justify-center p-4 transition-all duration-300">
                <img src="/logos/avpstack.png" alt="AVP Stack Technologies" className="h-20 md:h-28 object-contain transition-all duration-300 scale-95 group-hover:scale-100" />
              </div>
            </div>
          </div>
        </div>
